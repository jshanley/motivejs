! function() {
  ...
  primitives.scales = [{
...

    {
      ...
      source: ['melodic minor', 'down', 'M2']
    }, {
      name: 'lydian #5',
      intervals: ['R', 'M2', 'M3', 'A4', 'A5', 'M6', 'M7'],
      pattern: [2, 2, 2, 2, 1, 2, 1],
      source: ['melodic minor', 'down', 'm3']
    }, {
      name: 'lydian dominant',
      intervals: ['R', 'M2', 'M3', 'A4', 'P5', 'M6', 'm7'],
      pattern: [2, 2, 2, 1, 2, 1, 2],
      source: ['melodic minor', 'down', 'P4']
    }, {
      name: 'mixolydian b6',
      intervals: ['R', 'M2', 'M3', 'P4', 'P5', 'm6', 'm7'],
      pattern: [2, 2, 1, 2, 1, 2, 2],
      source: ['melodic minor', 'up', 'P4']
    }, {
      name: 'aeolian b5',
      intervals: ['R', 'M2', 'm3', 'P4', 'd5', 'm6', 'm7'],
      pattern: [2, 1, 2, 1, 2, 2, 2],
      source: ['melodic minor', 'up', 'm3']
    }, {
      name: 'altered',
      intervals: ['R', 'm2', 'm3', 'd4', 'd5', 'm6', 'm7'],
      pattern: [1, 2, 1, 2, 2, 2, 2],
      source: ['melodic minor', 'up', 'm2']
    },
    ...
    {
      name: 'diminished',
      intervals: ['R', 'M2', 'm3', 'P4', 'd5', 'm6', 'M6', 'M7'],
      pattern: [2, 1, 2, 1, 2, 1, 2, 1]
    }, {
      name: 'half-whole diminished',
      intervals: ['R', 'm2', 'm3', 'M3', 'A4', 'P5', 'M6', 'm7'],
    ...
    {
      name: 'whole tone',
      intervals: ['R', 'M2', 'M3', 'A4', 'A5', 'm7'],
      pattern: [2, 2, 2, 2, 2, 2]
    }
  ];
  primitives.tetrachords = [{
    name: 'ionian',
    pattern: [2, 2, 1]
  }, {
    name: 'dorian',
  ...
  Motive.Chord.prototype.transpose = function(direction, interval) {
    var root = this.root;
    var newroot = utilities.transpose(root, direction, interval);
